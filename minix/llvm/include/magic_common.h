/**
 * @file magic_common.h
 * @brief Magic instrumentation framework common definitions for LLVM-20 and
 * MINIX 3.1.8
 *
 * This header file contains essential constants, macros, and configuration
 * settings for the Magic instrumentation framework, specifically enhanced for
 * LLVM-20 compatibility and MINIX 3.1.8 operating system support.
 *
 * The Magic framework provides comprehensive memory safety, type safety, and
 * runtime analysis capabilities through compile-time instrumentation and
 * runtime monitoring.
 *
 * Key Features:
 * - LLVM-20 enhanced type analysis and memory tracking
 * - MINIX 3.1.8 specific optimizations and extensions
 * - Atomic memory operations support
 * - Enhanced debugging and profiling capabilities
 * - Thread-safe data structures with lockfree optimizations
 * - Comprehensive memory allocation tracking (heap, stack, mmap, etc.)
 * - Advanced Address Space Layout Randomization (ASLR) support
 * - Dynamic library instrumentation and analysis
 *
 * Configuration Options:
 * - Memory instrumentation levels (MAGIC_CHECK_LEVEL)
 * - Output control for debugging and performance testing
 * - Thread safety and atomic operations
 * - Platform-specific features (MINIX vs other systems)
 *
 * Data Structures:
 * - Sentries: Runtime metadata for memory allocations
 * - Types: Enhanced type information with LLVM-20 features
 * - Functions: Function metadata and instrumentation data
 * - DSEntries: Dynamic sentry tracking for runtime allocations
 *
 * Memory Regions Tracked:
 * - DATA: Global and static data segments
 * - HEAP: Dynamic memory allocations
 * - STACK: Function call stack allocations
 * - MAP: Memory-mapped regions
 * - SHM: Shared memory segments
 * - TEXT: Executable code segments
 * - LIB: Library code and data (static, dynamic, loaded)
 *
 * Version: MAGIC_LLVM20_MINIX318_2025
 * Compatible with: LLVM 20.x, MINIX 3.1.8+
 *
 * @author LLVM Magic Team
 * @version 20.0
 * @date 2025
 */
...
#define MAGIC_STRINGREF_HAS_MAGIC_HIDDEN_PREFIX(S)                             \
  ((S).starts_with(MAGIC_HIDDEN_ARRAY_PREFIX) ||                               \
   (S).starts_with(MAGIC_HIDDEN_STR_PREFIX))
...
#define MAGIC_FLATTEN_FUNCTION_ARGS                                            \
  0 /* Disabled for LLVM-20 variadic function compatibility */
#define MAGIC_CHECK_INVARIANTS 1
#define MAGIC_SHRINK_TYPE_STR 1
#define MAGIC_MAX_NAME_LEN 128         /* Increased for LLVM-20 */
#define MAGIC_MAX_TYPE_STR_LEN 512     /* Increased for complex types */
#define MAGIC_MAX_RECURSIVE_TYPES 2048 /* Increased for modern codebases */
...
#define MAGIC_NAMED_ALLOC_USE_DBG_INFO 1 /* Enable for LLVM-20 debug info */
...
#define MAGIC_MEM_USAGE_OUTPUT_CTL 1 /* Enable by default for LLVM-20 */
#endif
/* 0=disabled, 1=use call site info 2=use stacktrace 3=use LLVM-20 enhanced
 * debug info */
...
#define MAGIC_INSTRUMENT_HEAP_TRACKING 1 /* New for LLVM-20 */
#define MAGIC_INSTRUMENT_TYPE_SAFETY 1   /* Enhanced type safety */
#define MAGIC_FORCE_RAW_UNIONS 0
#define MAGIC_FORCE_RAW_BITFIELDS 0
#define MAGIC_FORCE_DYN_MEM_ZERO_INIT 1 /* Enhanced for security */
...
#ifdef __MINIX
#define MAGIC_USE_QPROF_INSTRUMENTATION 1 /* Enable for MINIX with LLVM-20 */
...
#define MAGIC_NUM_LL_BLOCK_EXT_TASK_CLASSES_NAME                               \
  "magic_num_ll_block_ext_task_classes"
#define MAGIC_NUM_LL_BLOCK_INT_TASK_CLASSES_NAME                               \
  "magic_num_ll_block_int_task_classes"
...
#define MAGIC_ATOMIC_OPERATIONS 1       /* New for LLVM-20 */
#define MAGIC_LOCKFREE_DATASTRUCTURES 1 /* Performance optimization */
...
#define MAGIC_LOOKUP_CACHE_OPTIMIZATION 1 /* New caching for LLVM-20 */

/* LLVM-20 Enhanced casting and type analysis */
...
#define MAGIC_INDEX_TRANSITIVE_BIT_CASTS 1 /* Enhanced for LLVM-20 */
#define MAGIC_INDEX_FUN_PTR_BIT_CAST 1
#define MAGIC_INDEX_STR_PTR_BIT_CAST 1
#define MAGIC_INDEX_VOID_PTR_BIT_CAST 1 /* Enhanced for LLVM-20 */
#define MAGIC_INDEX_OTH_PTR_BIT_CAST 1

#ifdef __MINIX
#define MAGIC_SKIP_TOVOID_PTR_BIT_CAST 0
#define MAGIC_MINIX_MEMORY_PROTECTION 1 /* Enhanced MINIX support */
#else
#define MAGIC_SKIP_TOVOID_PTR_BIT_CAST 1
#endif

#define MAGIC_COMPACT_COMP_TYPES 1 /* Enable for LLVM-20 optimization */

#define MAGIC_OFF_BY_N_PROTECTION_N 1 /* Enhanced protection */
...
/* LLVM-20 Debug and output control macros */
...
#define MAGIC_RSTRUCT_FIELD_ASR_HEAP_MAP_DO_PERMUTATE                          \
  "asr_heap_map_do_permutate"
...
#define MAGIC_RSTRUCT_FIELD_ASR_MAP_MAX_PADDING_PAGES                          \
  "asr_map_max_padding_pages"
...
#define MAGIC_RSTRUCT_FIELDS                                                   \
  MAGIC_RSTRUCT_FIELD_ASR_SEED, MAGIC_RSTRUCT_FIELD_ASR_HEAP_MAP_DO_PERMUTATE, \
      ...
      MAGIC_RSTRUCT_FIELD_NO_MEM_INST, MAGIC_RSTRUCT_FIELD_TYPES,              \
      MAGIC_RSTRUCT_FIELD_TYPES_NUM, MAGIC_RSTRUCT_FIELD_TYPES_NEXT_ID,        \
      MAGIC_RSTRUCT_FIELD_FUNCTIONS, MAGIC_RSTRUCT_FIELD_FUNCTIONS_NUM,        \
      MAGIC_RSTRUCT_FIELD_FUNCTIONS_NEXT_ID, MAGIC_RSTRUCT_FIELD_SENTRIES,     \
      MAGIC_RSTRUCT_FIELD_SENTRIES_NUM, MAGIC_RSTRUCT_FIELD_SENTRIES_STR_NUM,  \
      MAGIC_RSTRUCT_FIELD_SENTRIES_NEXT_ID, MAGIC_RSTRUCT_FIELD_DSINDEXES,     \
      MAGIC_RSTRUCT_FIELD_DSINDEXES_NUM, MAGIC_RSTRUCT_FIELD_FIRST_DSENTRY
...
#define MAGIC_SSTRUCT_FIELDS                                                   \
  MAGIC_SSTRUCT_FIELD_ID, MAGIC_SSTRUCT_FIELD_NAME, MAGIC_SSTRUCT_FIELD_TYPE,  \
      MAGIC_SSTRUCT_FIELD_FLAGS, MAGIC_SSTRUCT_FIELD_ADDRESS,                  \
...
#define MAGIC_TSTRUCT_FIELDS                                                   \
  MAGIC_TSTRUCT_FIELD_ID, MAGIC_TSTRUCT_FIELD_NAME, MAGIC_TSTRUCT_FIELD_NAMES, \
      MAGIC_TSTRUCT_FIELD_NUM_NAMES, MAGIC_TSTRUCT_FIELD_TYPE_STR,             \
      MAGIC_TSTRUCT_FIELD_SIZE, MAGIC_TSTRUCT_FIELD_NUM_CHILD_TYPES,           \
      MAGIC_TSTRUCT_FIELD_CONTAINED_TYPES,                                     \
      MAGIC_TSTRUCT_FIELD_COMPATIBLE_TYPES, MAGIC_TSTRUCT_FIELD_MEMBER_NAMES,  \
      MAGIC_TSTRUCT_FIELD_MEMBER_OFFSETS, MAGIC_TSTRUCT_FIELD_VALUE_SET,       \
      MAGIC_TSTRUCT_FIELD_TYPE_ID, MAGIC_TSTRUCT_FIELD_FLAGS,                  \
...
#define MAGIC_FSTRUCT_FIELDS                                                   \
  MAGIC_FSTRUCT_FIELD_ID, MAGIC_FSTRUCT_FIELD_NAME, MAGIC_FSTRUCT_FIELD_TYPE,  \
      MAGIC_FSTRUCT_FIELD_FLAGS, MAGIC_FSTRUCT_FIELD_ADDRESS
...
#define MAGIC_DSTRUCT_FIELDS                                                   \
  MAGIC_DSTRUCT_FIELD_TYPE, MAGIC_DSTRUCT_FIELD_NAME,                          \
      MAGIC_DSTRUCT_FIELD_PARENT_NAME, MAGIC_DSTRUCT_FIELD_FLAGS
...
#define MAGIC_TYPE_LLVM20_ENHANCED 0x100 /* New flag for LLVM-20 features */
#define MAGIC_TYPE_ATOMIC_SAFE 0x200     /* Atomic operation safety */
#define MAGIC_TYPE_MEMORY_TAGGED 0x400   /* Memory tagging support */

/* Enhanced state flags for sentries and functions. */
...
#define MAGIC_STATE_LLVM20_INSTRUMENTED 0x40000000 /* New for LLVM-20 */
#define MAGIC_STATE_ENHANCED_TRACKING 0x80000000   /* Enhanced tracking */
...
#define MAGIC_STATE_FLAGS_REGION_C(F)                                          \
  (((F) & MAGIC_STATE_DATA)    ? 'D'                                           \
   : ((F) & MAGIC_STATE_HEAP)  ? 'H'                                           \
   : ((F) & MAGIC_STATE_SHM)   ? 'X'                                           \
   : ((F) & MAGIC_STATE_MAP)   ? 'M'                                           \
   : ((F) & MAGIC_STATE_STACK) ? 'S'                                           \
   : ((F) & MAGIC_STATE_TEXT)  ? 'T'                                           \
                               : '?')
#define MAGIC_STATE_FLAGS_LIBSPEC_C(F)                                         \
  (((F) & MAGIC_STATE_LIB) ? (((F) & MAGIC_STATE_LIB_SO)    ? 'l'              \
                              : ((F) & MAGIC_STATE_LIB_DSO) ? 'o'              \
                                                            : 'L')             \
                           : '0')
...
#define MAGIC_STATE_EXTF_ADD(E, F) ((E)->flags |= MAGIC_STATE_EXTF_TO_FLAGS(F))
#define MAGIC_STATE_EXTF_DEL(E, F) ((E)->flags &= ~MAGIC_STATE_EXTF_TO_FLAGS(F))
...
#define MAGIC_CALL_ANNOTATE(C, VALUE)                                          \
  do {                                                                         \
    C;                                                                         \
    MAGIC_CALL_ANNOTATION_VAR = VALUE;                                         \
  } while (0)
...
#define MAGIC_MEMPOOL_FUNCS                                                    \
  MAGIC_MEMPOOL_CREATE_FUNCS, MAGIC_MEMPOOL_DESTROY_FUNCS,                     \
      MAGIC_MEMPOOL_MGMT_FUNCS, MAGIC_MEMPOOL_RESET_FUNCS
...
#define MAGIC_HOOK_DEBUG_MASK (MAGIC_PRE_HOOK_DEBUG | MAGIC_POST_HOOK_DEBUG)

#if (MAGIC_MEM_USAGE_OUTPUT_CTL == 1)
#define MAGIC_MEMPOOL_CREATE_FUNC_FLAGS                                        \
  MAGIC_PRE_HOOK_SIMPLE_CALL | MAGIC_POST_HOOK_FORWARDING_CALL |               \
...
#define MAGIC_MEMPOOL_FUNC_FLAGS                                               \
  MAGIC_MEMPOOL_CREATE_FUNC_FLAGS, MAGIC_MEMPOOL_DESTROY_FUNC_FLAGS,           \
      MAGIC_MEMPOOL_MGMT_FUNC_FLAGS, MAGIC_MEMPOOL_RESET_FUNC_FLAGS
...
#define MAGIC_MEMA_EXTRA_FUNC_ALLOC_FLAGS , MAGIC_STATE_MAP, MAGIC_STATE_HEAP
#else
...
#define MAGIC_MEMD_FUNC_ALLOC_FLAGS 0, 0, 0

#define MAGIC_MEM_FUNCS                                                        \
  MAGIC_MEMA_FUNCS MAGIC_MEMA_EXTRA_FUNCS, MAGIC_MEMD_FUNCS
#define MAGIC_MEM_UNS_FUNCS __X(mmap2), __X(remap_file_pages), __X(mremap)
#define MAGIC_MEM_FUNC_ALLOC_FLAGS                                             \
  MAGIC_MEMA_FUNC_ALLOC_FLAGS MAGIC_MEMA_EXTRA_FUNC_ALLOC_FLAGS,               \
      MAGIC_MEMD_FUNC_ALLOC_FLAGS

#ifdef __MINIX
/* Enhanced nested allocation functions for LLVM-20 with MINIX3.
 * These functions are called as part of allocation functions and need
 * enhanced tracking for LLVM-20's improved memory analysis.
 */
