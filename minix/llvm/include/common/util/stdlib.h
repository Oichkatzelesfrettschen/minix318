...
#define _UTIL_STDLIBS_INITIALIZER                                              \
  {_UTIL_STDLIB_DEF(STDLIB_ACCEPT, "accept",                                   \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_ACCEPT4, "accept4",                                 \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   ...
   _UTIL_STDLIB_DEF(STDLIB_EPOLL_WAIT, "epoll_wait",                           \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   ...
   _UTIL_STDLIB_DEF(STDLIB_PTHREAD_COND_WAIT, "pthread_cond_wait",             \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_INT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_PTHREAD_COND_TIMEDWAIT, "pthread_cond_timedwait",   \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_INT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_PTHREAD_JOIN, "pthread_join",                       \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_INT)),                        \
   ...
   _UTIL_STDLIB_DEF(STDLIB_RECVFROM, "recvfrom",                               \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_RECVMSG, "recvmsg",                                 \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_SBRK, "sbrk", 0),                                   \
   _UTIL_STDLIB_DEF(STDLIB_SELECT, "select",                                   \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_SEMOP, "semop", _UTIL_STLIB_FLAG(STLIB_BLOCK_INT)), \
   _UTIL_STDLIB_DEF(STDLIB_SEMTIMEDOP, "semtimedop",                           \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_INT)),                        \
   ...
   _UTIL_STDLIB_DEF(STDLIB_SIGSUSPEND, "sigsuspend",                           \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_SIGTIMEDWAIT, "sigtimedwait",                       \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_SIGWAITINFO, "sigwaitinfo",                         \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_SLEEP, "sleep", _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)), \
   _UTIL_STDLIB_DEF(STDLIB_SOCKET, "socket", 0),                               \
   _UTIL_STDLIB_DEF(STDLIB_USLEEP, "usleep",                                   \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_EXT)),                        \
   _UTIL_STDLIB_DEF(STDLIB_VALLOC, "valloc", 0),                               \
   _UTIL_STDLIB_DEF(STDLIB_WAITPID, "waitpid",                                 \
                    _UTIL_STLIB_FLAG(STLIB_BLOCK_INT))}

/**
 * Looks up a utility standard library entry by its name.
 *
 * @param name The name of the standard library entry to look up.
 * @param stlib_arr An array of util_stdlib_t structures representing the
 * standard library entries.
 * @return A pointer to the util_stdlib_t structure corresponding to the given
 * name, or NULL if not found.
 */
static inline util_stdlib_t *
util_stdlib_lookup_by_name(const char *name, util_stdlib_t *stlib_arr) {
  int i;
...
#endif /* _UTIL_STDLIB_H */ /* End of _UTIL_STDLIB_H guard */
