...
static XObj		bidNewSessn( XObj, XObj, XObj, ActiveKey * );
    ...
    ActiveKey	*key;
{
	...
	s = bidNewSessn(self, hlpRcv, hlpType, key);
    }
...
static XObj
bidNewSessn( self, hlpRcv, hlpType, key )
    XObj	self, hlpRcv, hlpType;
    ActiveKey	*key;
{
    XObj	s, llpCtl;
