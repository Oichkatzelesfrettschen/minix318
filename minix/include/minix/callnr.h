...
#define PM_PID_REPLY		(PM_BASE + 49) /* Reply type from PM when returning a PID */

#define NR_PM_CALLS		49	/* highest incoming call number from base plus one. Does not include reply types. */
