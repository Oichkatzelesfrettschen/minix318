/**
 * @file acpi.c
 * @brief ACPI user interface library.
 */
...
/**
 * Initialize communication with the ACPI service.
 * @return OK on success or an error code from DS.
 */
int acpi_init(void) {
  int res;
...
/**
 * Request the IRQ mapped for a PCI device.
...
/**
 * Map a PCI-PCI bridge for ACPI.
 * @param pbnr Primary bus.
 * @param dev Device ID.
