/**
 * @file utdelete_unified.c
 * @brief Unified utdelete implementation
 ...
 *     1. minix4\exokernel\minix_drivers\power\acpi\utilities\utdelete.c ( 807 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\common\acpica\utilities\utdelete.c ( 921 lines,  0 functions)
 * 
...
/*
 * END OF FILE: utdelete_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
