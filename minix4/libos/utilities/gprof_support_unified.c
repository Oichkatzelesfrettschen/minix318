/**
 * @file gprof_support_unified.c
 * @brief Unified gprof_support implementation
 ...
 *     1. minix4\microkernel\servers\serv\gprof_support.c              ( 530 lines,  0 functions)
 *     2. minix4\libos\lib_legacy\openssl\lib\posix\serv\gprof_support.c ( 520 lines,  0 functions)
 * 
...
/*
 * END OF FILE: gprof_support_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
