/**
 * @file port_mgr_unified.c
 * @brief Unified port_mgr implementation
 ...
 *     1. minix4\microkernel\servers\util\port_mgr.c                   ( 270 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\inkernel\include\port_mgr.c   (   1 lines,  0 functions)
 * 
...
/*
 * END OF FILE: port_mgr_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
