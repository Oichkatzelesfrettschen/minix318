/**
 * @file serv_synch_unified.c
 * @brief Unified serv_synch implementation
 ...
 *     1. minix4\microkernel\servers\serv\serv_synch.c                 ( 705 lines,  2 functions)
 *     2. minix4\libos\lib_legacy\openssl\lib\posix\serv\serv_synch.c  ( 704 lines,  2 functions)
 * 
...
/* Function   1/4 - Complexity:  8, Lines:  16 */
		|| HAVE_SIGNALS(p)) {
		    int ret = 0;
		    thread_unsleep_internal(pk);
...
/* Function   2/4 - Complexity:  8, Lines:  16 */
		|| HAVE_SIGNALS(p)) {
		    int ret = 0;
		    thread_unsleep_internal(pk);
		    mutex_unlock(&sleep_lock);
...
/*
 * END OF FILE: serv_synch_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 4
