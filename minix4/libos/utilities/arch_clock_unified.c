/**
 * @file arch_clock_unified.c
 * @brief Unified arch_clock implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\arch\earm\arch_clock.c        ( 256 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\arch\i386\arch_clock.c        ( 449 lines,  0 functions)
 * 
...
/*
 * END OF FILE: arch_clock_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
