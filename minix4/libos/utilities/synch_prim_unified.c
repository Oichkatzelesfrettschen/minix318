/**
 * @file synch_prim_unified.c
 * @brief Unified synch_prim implementation
 ...
 *     1. minix4\microkernel\servers\serv\synch_prim.c                 ( 474 lines,  0 functions)
 *     2. minix4\libos\lib_legacy\openssl\lib\posix\serv\synch_prim.c  ( 473 lines,  0 functions)
 * 
...
/*
 * END OF FILE: synch_prim_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
