/**
 * @file ddi_arch_unified.c
 * @brief Unified ddi_arch implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\uts\sparc\os\ddi_arch.c       ( 269 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\uts\intel\os\ddi_arch.c       ( 351 lines,  0 functions)
 * 
...
/*
 * END OF FILE: ddi_arch_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
