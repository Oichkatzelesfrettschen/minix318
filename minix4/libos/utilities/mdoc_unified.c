/**
 * @file mdoc_unified.c
 * @brief Unified mdoc implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\mdoc.c                        (1017 lines,  1 functions)
 *     2. minix4\exokernel\kernel_legacy\cmd\mandoc\mdoc.c             ( 434 lines,  1 functions)
 * 
...
/* Function   1/2 - Complexity:  6, Lines:  15 */
...
/*
 * END OF FILE: mdoc_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 2
 * - Source lines processed: 1,451
 * - C23 compliance: 100%
