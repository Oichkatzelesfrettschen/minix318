/**
 * @file mach_kdi_unified.c
 * @brief Unified mach_kdi implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\uts\i86xpv\os\mach_kdi.c      ( 207 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\uts\i86pc\os\mach_kdi.c       ( 169 lines,  0 functions)
 * 
...
/*
 * END OF FILE: mach_kdi_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
