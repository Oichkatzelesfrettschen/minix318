/**
 * @file callback_unified.c
 * @brief Unified callback implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\common\ficl\callback.c        (  68 lines,  2 functions)
 *     2. minix4\exokernel\kernel_legacy\cmd\scadm\sparc\mpxu\common\callback.c (  58 lines,  0 functions)
 * 
...
/*
 * END OF FILE: callback_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 2
