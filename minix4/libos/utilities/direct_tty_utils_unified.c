/**
 * @file direct_tty_utils_unified.c
 * @brief Unified direct_tty_utils implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\arch\earm\direct_tty_utils.c  (  36 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\arch\i386\direct_tty_utils.c  ( 137 lines,  0 functions)
 * 
...
/*
 * END OF FILE: direct_tty_utils_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
