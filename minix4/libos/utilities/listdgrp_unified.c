/**
 * @file listdgrp_unified.c
 * @brief Unified listdgrp implementation
 ...
 *     1. minix4\libos\lib_legacy\libadm\common\listdgrp.c             ( 169 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\cmd\devmgmt\cmds\listdgrp.c   ( 236 lines,  0 functions)
 * 
...
/*
 * END OF FILE: listdgrp_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
