/**
 * @file chgrp_unified.c
 * @brief Unified chgrp implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\contrib\ast\src\lib\libcmd\chgrp.c ( 508 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\cmd\chgrp\chgrp.c             ( 542 lines,  2 functions)
 * 
...
/* Function   2/2 - Complexity:  1, Lines:   2 */
		    (strcmp(dp->d_name, "..") == 0)) {
		}
