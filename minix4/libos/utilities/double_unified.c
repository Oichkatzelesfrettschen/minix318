/**
 * @file double_unified.c
 * @brief Unified double implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\double.c                      (  49 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\common\ficl\double.c          ( 441 lines,  1 functions)
 * 
