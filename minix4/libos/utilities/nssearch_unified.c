/**
 * @file nssearch_unified.c
 * @brief Unified nssearch implementation
...
/*
 * END OF FILE: nssearch_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
