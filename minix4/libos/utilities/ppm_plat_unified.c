/**
 * @file ppm_plat_unified.c
 * @brief Unified ppm_plat implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\uts\sun4u\io\ppm_plat.c       ( 358 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\uts\i86pc\io\ppm_plat.c       ( 297 lines,  1 functions)
 * 
...
/*
 * END OF FILE: ppm_plat_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 1
