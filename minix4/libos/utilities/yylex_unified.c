/**
 * @file yylex_unified.c
 * @brief Unified yylex implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\yylex.c                       ( 349 lines,  1 functions)
 *     2. archive\unix_v6v7\yacc\yylex.c                               ( 349 lines,  1 functions)
 *     3. archive\legacy\pascal\yylex.c                                ( 349 lines,  1 functions)
 * 
