/**
 * @file arch_system_unified.c
 * @brief Unified arch_system implementation
 ...
 *     1. minix4\exokernel\kernel_legacy\arch\earm\arch_system.c       ( 254 lines,  0 functions)
 *     2. minix4\exokernel\kernel_legacy\arch\i386\arch_system.c       ( 726 lines,  1 functions)
 * 
...
/*
 * END OF FILE: arch_system_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 1
