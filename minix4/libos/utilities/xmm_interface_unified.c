/**
 * @file xmm_interface_unified.c
 * @brief Unified xmm_interface implementation
 ...
 *     1. minix4\microkernel\servers\serv\xmm_interface.c              ( 609 lines,  0 functions)
 *     2. minix4\libos\lib_legacy\openssl\lib\posix\serv\xmm_interface.c ( 609 lines,  0 functions)
 * 
...
/*
 * END OF FILE: xmm_interface_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 0
