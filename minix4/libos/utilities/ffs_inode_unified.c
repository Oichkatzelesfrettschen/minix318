/**
 * @file ffs_inode_unified.c
 * @brief Unified ffs_inode implementation
 ...
 *     1. minix4\microkernel\servers\ufs\ffs\ffs_inode.c               ( 502 lines,  1 functions)
 *     2. minix4\libos\lib_legacy\openssl\lib\posix\ufs\ffs\ffs_inode.c ( 501 lines,  1 functions)
 * 
...
/*
 * END OF FILE: ffs_inode_unified.c
 * =======================
 * 
 * SYNTHESIS SUMMARY:
 * - Functions unified: 2
